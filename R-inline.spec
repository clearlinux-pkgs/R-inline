...
Version  : 0.3.21
Release  : 57
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/inline_0.3.21.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/inline_0.3.21.tar.gz
...
%setup -q -n inline
pushd ..
cp -a inline buildavx2
popd
pushd ..
cp -a inline buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736459949
