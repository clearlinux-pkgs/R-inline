...
Source0  : https://cran.r-project.org/src/contrib/inline_0.3.14.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1523310162
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library inline|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
